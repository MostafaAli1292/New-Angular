...
@Component({
  selector: 'app-bookingsuccessfullyoffer',
  templateUrl: './bookingsuccessfullyoffer.component.html',
  styleUrls: ['./bookingsuccessfullyoffer.component.scss']
})
export class BookingsuccessfullyofferComponent {
  ...
  ngOnInit(): void {
    ...
    console.log("locals"+ lang);
     ...
     this.booking = JSON.parse(localStorage.getItem('bookingData') || '{}') ;
     this.area=this.booking['doctor']['HealthEntityDTO']['CityName']+" "+this.booking['doctor']['HealthEntityDTO']['AreaName'];
     this.address = this.booking['doctor']['HealthEntityDTO']['Address'];
     if(this.booking['doctor']['HealthEntityDTO']['FloorNo'] != null && this.booking['doctor']['HealthEntityDTO']['FloorNo']!='0'){

       this.address=this.address+" "+  this.floor+" "+this.booking['doctor']['HealthEntityDTO']['FloorNo'] ;
     }

     if(this.booking['doctor']['HealthEntityDTO']['ApartmentNo'] != null && this.booking['doctor']['HealthEntityDTO']['ApartmentNo']!='0'){

       this.address=this.address+" "+this.appartment+" "+this.booking['doctor']['HealthEntityDTO']['ApartmentNo'] ;
     }
